...
java -Xss10m -cp src:jackson-annotations-2.18.1.jar:jackson-core-2.18.1.jar:jackson-databind-2.18.1.jar  src/particia_trie/profondeurMoyenne_pat.java "$y"
elif [ "$x" -eq 1 ]; then
...
java -Xss10m -cp src:jackson-annotations-2.18.1.jar:jackson-core-2.18.1.jar:jackson-databind-2.18.1.jar  src/com/Hybrides/profondeurMoyenne_hyb.java "$y"
else
